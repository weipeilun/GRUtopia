...
from grutopia_extension.training.ppo import ActorCritic
from grutopia_extension.training.ppo import RolloutStorage
...
class PPO:
    ...
    def process_env_step(self, rewards, dones, env_bins, infos):
        self.transition.rewards = rewards.clone()
        self.transition.dones = dones
        self.transition.env_bins = env_bins
